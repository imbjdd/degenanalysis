	    ...
	    <div className="relative flex flex-col-reverse lg:flex-row gap-12 lg:gap-32	 items-center justify-between max-w-5xl w-full lg:py-24">
	    	<div className="flex flex-col lg:w-1/2">
	    		<div className="border-b py-12">
	    			<p className="text-4xl lg:text-6xl font-bold text-sky-900">Degen-based</p>
	    		</div>
	    		<div className="border-b py-12">
	    			<p className="text-4xl lg:text-6xl font-bold text-sky-900">Open-Source</p>
	    		</div>
	    		<div className="py-12">
	    			<p className="text-4xl lg:text-6xl font-bold text-sky-900">Open-Data</p>
	    		</div>
